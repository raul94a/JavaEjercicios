...
public class RsaAlgorithm {
    ...
    private final int maximumLength = 4096/4;
    ...
    public void KeyGeneration() {
        ...
        System.out.println("Val_e: " + val_e);
        String pk = HexFormat.of().formatHex(val_e.toByteArray());
        System.out.println("Public Key: " + pk);
        System.out.println("Val_e from pk: " + new BigInteger(pk,16));
    }
